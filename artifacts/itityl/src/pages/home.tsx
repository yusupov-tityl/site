...
const products = [
  {
    ...
    desc: "Инструменты для ускорения обработки входящих и внутренних документов, маршрутизации, проверки и подготовки информации.",
  },
  {
    name: "Аналитик документов",
    desc: "Решения для анализа, структурирования и извлечения данных из массивов документов и регламентной информации.",
  },
  {
    name: "RAG-решения для поиска по внутренним материалам",
    desc: "Системы поиска и ответов по корпоративным документам, базам знаний, инструкциям и архивам.",
  },
  {
    name: "ИИ-агенты под бизнес-задачи",
    desc: "Юридическая проверка, помощник с закупками и другие прикладные сценарии для помощи сотрудникам, работе с информацией и автоматизации типовых операций.",
  },
];
...
export default function Home() {
  useSeo({
    title: "Ай-Титул — внедрение ИИ для бизнеса и госсектора | LLM, RAG, ИИ-агенты",
    description:
    ...
    <div className="min-h-screen bg-black text-white selection:bg-amber-400 selection:text-black overflow-x-hidden">
      ...
      <section className="py-32 px-6 md:px-10 bg-black text-white border-b border-white/15">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 border-t border-white/15 pt-16">
            {audiences.map((a, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
