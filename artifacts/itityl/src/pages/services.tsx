...
const services = [
  {
    t: "AI-консалтинг",
    d: "Проводим обследование процессов, документов, данных и текущего ИТ-ландшафта, определяем где искусственный интеллект даст реальный эффект, формируем приоритизированный портфель инициатив с оценкой сроков, бюджета и ожидаемого результата по каждой.",
    to: "/services/ai-consulting",
  },
  {
    t: "Пилоты и проверка гипотез",
    d: "Запускаем пилотные проекты, чтобы проверить применимость сценария на реальных данных и в реальной рабочей среде. Срок пилота — 4–8 недель, на выходе измеримый результат и решение о промышленном внедрении.",
    to: "/services/pilots",
  },
  {
    t: "Разработка ИИ-решений",
    d: "Проектируем и создаём прикладные решения под конкретные задачи бизнеса с учётом процессов, инфраструктуры и требований безопасности. Работаем с LLM, RAG, компьютерным зрением и речевыми технологиями.",
    to: "/services/development",
  },
  {
    t: "Интеграция в корпоративные системы",
    d: "Встраиваем решения в действующие процессы, внутренние сервисы, документооборот и ИТ-ландшафт организации. Работаем on-premise или в частном облаке заказчика — данные не покидают контур.",
